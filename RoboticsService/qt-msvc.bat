...
set QT_TOOLS_DIR=D:\MyProgram\Qt6\Tools\CMake_64\bin
set NINJA_PATH=D:\MyProgram\Qt6\Tools\Ninja
set MSVC_DIR=D:\MyProgram\Microsoft Visual Studio\2019\Community\VC\Tools\MSVC\14.29.30133\bin\HostX64\x64
set VS_DIR=D:\MyProgram\Microsoft Visual Studio\2019\Community

REM Setup Visual Studio environment
call "%VS_DIR%\VC\Auxiliary\Build\vcvars64.bat"
set SOURCE_DIR=E:\code\RoboticsService-PC\RoboticsService
set BUILD_DIR=E:\code\RoboticsService-PC\build-RoboticsService-Desktop_Qt_6_6_2_MSVC2019_64bit-RelWithDebInfo
